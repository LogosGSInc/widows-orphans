const DONATE_URL = import.meta.env.VITE_STRIPE_DONATE_URL || 'https://donate.stripe.com/PLACEHOLDER';
...
export function DonateButton() {
  return (
    <a
      ...
      className="inline-flex items-center gap-1.5 bg-chrome/20 hover:bg-chrome/30 text-white text-xs font-medium px-3 py-1.5 rounded-full transition-colors"
